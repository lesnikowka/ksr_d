...
namespace lab1_dotnet_framework
{
    ...
    public partial class MainForm : Form
    {
        ...
        private string folder3D = "/../../../3d_plane/plane.png";
        ...
        public string getScriptFolder()
        {
            try
            {
                StreamReader sr = new StreamReader(Directory.GetCurrentDirectory() + scriptFolder + "/KSR.py");
                sr.Close();
            }
            catch
            {
        ...
        private void executeMethod()
        {
            ...
            infoStartProcess.FileName = "KSR.py";
        ...
        private void drawGraphs(List<string> startCondition)
        {
            ...
            else
            {
                ...
                this.pictureBox1.Image = new Bitmap(Directory.GetCurrentDirectory() +  folder3D);
